...
// File:        GENERIC.C
//
// Purpose:     Template for creating 32-bit XLLs for Microsoft Excel 2007.
//
...
[g_rgWorksheetFuncsRows][g_rgWorksheetFuncsCols] =
{
	...
	{ L"FuncSum",
		L"UUUUUUUUUUUUUUUUUUUUUUUUUUUUUU", // up to 255 args in Excel 2007, 
...
extern void FAR PASCAL HookExcelWindow(HANDLE hWndExcel)
{
	...
	g_lpfnExcelWndProc = (WNDPROC) GetWindowLong(hWndExcel, GWL_WNDPROC);
